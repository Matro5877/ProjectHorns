...
public class Chara : MonoBehaviour
{
    ...
    {
        rightControl = (forcedRight || (keysEnabled && (Input.GetKey(KeyCode.RightArrow) || Input.GetKey(KeyCode.D) || Input.GetKey(KeyCode.Keypad6) || Input.GetAxisRaw("Horizontal") > 0.1f || Input.GetAxis("HorizontalMenu") > 0.1f)));
        leftControl = (keysEnabled && (Input.GetKey(KeyCode.LeftArrow) || Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.Keypad4) || Input.GetAxisRaw("Horizontal") < - 0.1f || Input.GetAxis("HorizontalMenu") < - 0.1f));
        ...
        jumpControl = (keysEnabled && (Input.GetKeyDown(KeyCode.X) || Input.GetKeyDown(KeyCode.Space) || Input.GetKeyDown(KeyCode.Keypad8) || Input.GetKeyDown(KeyCode.W) || Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.Numlock) || Input.GetKeyDown(KeyCode.JoystickButton0) || Input.GetKeyDown(KeyCode.JoystickButton1)));
        ...
        dashControl = (keysEnabled && (groundCheck && Input.GetKey(KeyCode.V) || Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.Keypad7) || Input.GetKey(KeyCode.Keypad1) || Input.GetKey(KeyCode.KeypadMinus) || Input.GetKey(KeyCode.F6) || Input.GetKey(KeyCode.JoystickButton3) || Input.GetKey(KeyCode.RightControl) || Input.GetKey(KeyCode.JoystickButton4) || Input.GetKey(KeyCode.JoystickButton5)));
        dashControlUp = (keysEnabled && (groundCheck && Input.GetKeyDown(KeyCode.V) || Input.GetKeyDown(KeyCode.LeftControl) || Input.GetKeyDown(KeyCode.Keypad7) || Input.GetKeyDown(KeyCode.Keypad1) || Input.GetKeyDown(KeyCode.KeypadMinus) || Input.GetKeyDown(KeyCode.F6) || Input.GetKeyDown(KeyCode.JoystickButton3) || Input.GetKeyDown(KeyCode.RightControl) || Input.GetKeyDown(KeyCode.JoystickButton4) || Input.GetKeyDown(KeyCode.JoystickButton5)));
        ...
        fallControl = (keysEnabled && (Input.GetKey(KeyCode.X) || Input.GetKey(KeyCode.Space) || Input.GetKey(KeyCode.Keypad8) || Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.UpArrow) || Input.GetKey(KeyCode.Numlock) || Input.GetKey(KeyCode.JoystickButton0) || Input.GetKey(KeyCode.JoystickButton1)));
    }
